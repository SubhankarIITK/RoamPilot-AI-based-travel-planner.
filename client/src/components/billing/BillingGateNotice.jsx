...
export default function BillingGateNotice() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-[80] mx-auto max-w-xl rounded-2xl border border-indigo-200 bg-white p-4 shadow-2xl dark:border-indigo-400/20 dark:bg-slate-900 sm:flex sm:items-center sm:gap-4">
