export default function EmptyState({ icon = '📭', title, message, action }) {
  return (
    <div className="relative isolate flex min-h-64 flex-col items-center justify-center overflow-hidden rounded-2xl border border-emerald-200/80 bg-gradient-to-br from-white via-emerald-50/70 to-lime-50/50 px-4 py-10 text-center shadow-[0_18px_55px_rgba(5,150,105,0.08)] dark:border-emerald-300/15 dark:from-[#071d17] dark:via-[#09251d] dark:to-[#0d2a1d] dark:shadow-[0_22px_65px_rgba(0,0,0,0.24)] sm:min-h-72 sm:rounded-3xl sm:px-6 sm:py-14">
      ...
      {action && <div className="empty-state-actions flex w-full flex-wrap justify-center gap-2 sm:w-auto">{action}</div>}
    </div>
  );
}
